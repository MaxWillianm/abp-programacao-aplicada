...
class Thumbhash
{
    ...
    public static function convertHashToString($hash)
    {
        return rtrim(base64_encode(implode(array_map("chr", $hash))), '=');
    }

    public static function convertStringToHash($str)
    {
     ...
     */
    public static function hashToRGBA($hash)
    {
        // Read the constants
     ...
     */
    public static function toApproximateAspectRatio($hash)
    {
        $header = $hash[3];
     ...
     */
    public static function rgbaToDataURL($w, $h, $rgba)
    {
        $row = $w * 4 + 1;
        $idat = 6 + $h * (5 + $row);
        $bytes = [
     ...
     */
    public static function toDataURL($hash)
    {
