...
$userFolder = '/files/';
$pathInvoke = '/webroot';
$baseUrl = str_replace(strstr($_SERVER['PHP_SELF'], $pathInvoke), $userFolder, $_SERVER['PHP_SELF']);
 ...
 */
$baseDir = resolveUrl($baseUrl);
$baseDir = str_replace($userFolder, $pathInvoke . $userFolder, $baseDir);
 ...
 */
$config['HtmlExtensions'] = array('html', 'htm', 'xml');
