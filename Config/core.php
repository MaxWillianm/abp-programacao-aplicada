 ...
 */
Configure::write('Cache.viewPrefix', 'desktop_');
 ...
 */
Configure::write('Security.salt', 'e2ab1cebbd88e1e2ffeba65122df3ef7');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '9430751384202215937586136710');
...
if (defined("CACHE"))
{
  ...
  Cache::config('temp', array(
    'engine' => $engine,
    'prefix' => $prefix . 'cake_temp_',
    'path' => CACHE . 'temp' . DS,
    'serialize' => ($engine === 'File'),
    'duration' => '+5 minutes',
  ));
